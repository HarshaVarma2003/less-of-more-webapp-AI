...
const Navbar = () => {
  ...
  return <nav className="py-6 px-4 md:px-8 w-full z-50">
      <div className="flex items-center justify-between">
        ...
        <div className="md:hidden">
          <button onClick={toggleMenu} className="text-lom-light hover:text-lom-yellow transition-colors" aria-label="Toggle menu">
            <Menu size={24} />
          </button>
        </div>
      </div>
      ...
      {/* Mobile Menu */}
      {isMenuOpen && <div className="md:hidden mt-4 py-4 bg-black animate-fade-in">
